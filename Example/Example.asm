...
ProjectS11Data:
	...
	DW	Inst_s11space
	DB	BANK(Music_s11space)
	DW	Music_s11space
PlanetFuzzData:
	DB	BANK(Inst_planetfuzz)
	DW	Inst_planetfuzz
	DB	BANK(Music_planetfuzz)
	DW	Music_planetfuzz
IDMKillerData:
	DB	BANK(Inst_killer)
	DW	Inst_killer
	DB	BANK(Music_killer)
	DW	Music_killer
BobData:
	DB	BANK(Inst_bob)
	DW	Inst_bob
	...
	DW	Music_bob
CeramicData:
	DB	BANK(Inst_ceramic)
	DW	Inst_ceramic
	DB	BANK(Music_ceramic)
	DW	Music_ceramic
Station0Data:
	DB	BANK(Inst_station0)
	DW	Inst_station0
